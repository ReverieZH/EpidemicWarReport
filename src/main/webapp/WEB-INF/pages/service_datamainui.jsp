							...
							<ul id="side_nav" class="layui-nav layui-nav-tree " style="margin-right: 10px;">
								<div class="div" >
									 <li class="layui-nav-item layui-nav-itemed"><span>信息填报系统</span><div style="float:right;"><i class="fa fa-angle-down" aria-hidden="true"></i></div>
									  <ul>
									   <li ><a href="service_taskmainui.jsp"><i class="layui-icon layui-icon-spread-left"></i> 表单任务设置</a></li>
									   <li class="layui-this"><a href="#"><i class="layui-icon layui-icon-component"></i>采集数据结果</a></li>
									  </ul>
									 </li>
								 </div>
								 <div class="div" >
