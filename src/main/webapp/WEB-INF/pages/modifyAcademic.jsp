...
<body>
    <% Academic academic= (Academic) request.getAttribute("academic");%>
    <table class="table_context" width="100%">
        <tr>
            <input type="hidden" name="academicId" id="academicId" value="<%=academic.getAcademicId()%>">
            <td width="10%" height="50" align="right">学院名称名称:<span style="color: red;">*</span></td>
            <td width="10%" height="50" align="left"><input id="academicName" name="academicName"  value="<%=academic.getAcademicName()%>" type="text"></td>
        </tr>

        <tr>
            <td width="10%" height="50" align="right">使用状态:</td>
            <td width="10%" height="50" align="left"> <select id="statusop" name="statusop" lay-verify="" >
                <option value="<%=academic.getStatus()%>" disabled selected hidden><%=academic.getStatus().equals("1")?"使用中":"禁用中"%></option>
