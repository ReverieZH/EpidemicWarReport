	...
	<body style=" overflow-x:hidden;"  class="inner-container">
		...
		<table class="layui-table" style="width: 1050px;" lay-skin="line">
		             <tr>
                        ...
                        <td width="10%" height="20" align="center" >学院信息</td>
            ...
            <%
                Integer i= 0;
                PageBean<Academic> pageBean= (PageBean<Academic>) request.getAttribute("pageBean");
            %>
            ...
            <c:forEach begin="0" end="${pageBean.pageSize}" items="${pageBean.list}" var="task">
                <c:if test="${i<pageBean.totalRecord}">
                    <tr>
                        ...
                        <td width="2%" height="50" align="center"><input  type="checkbox" name="academicId" value="<%=pageBean.getList().get(i).getAcademicId()%>"></td>
                        ...
                        <%}%>
                        <td width="12%" height="50" align="center"><button class="layui-btn" onclick="getiframe('getmodifyAcademic.do?academicId=<%=pageBean.getList().get(i).getAcademicId()%>')">编辑</button> <button class="layui-btn layui-btn-warm" onclick="changeStatus('<%=pageBean.getList().get(i).getAcademicId()%>','0')" >禁用</button> <button class="layui-btn layui-btn-danger" onclick="deleteOneAcademic('<%=pageBean.getList().get(i).getAcademicId()%>')">删除</button></td>
                    </tr>
                </c:if>
